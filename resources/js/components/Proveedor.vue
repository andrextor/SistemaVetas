               ...
               <div class="modal-body">
                  <form action method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                           <input type="text" v-model="contacto" class="form-control"  placeholder="Ingresa un contacto">
                           <!-- <span class="help-block">(*) Ingrese el nombre de la producto</span> -->
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label" for="text-input">Telefono Contacto</label>
                        <div class="col-md-9">
                           <input type="text" v-model="telefono_contacto" class="form-control"  placeholder="Ingresa un telefono de contacto">
                           <!-- <span class="help-block">(*) Ingrese el nombre de la producto</span> -->
                        </div>
                    </div>
   ...
   methods: {
    ...
    actualizarCliente() {
        ...
        axios.put("/proveedor/actualizar", {
            ...
            this.cerrarModal();
            this.alertaSuccess('EL proveedor '+ response.data.nombre +' actualizado Exitosamente');
            this.listarProveedor(this.pagination.current_page, "", "nombre");
            this.clientes = response.data;
    ...
    validacionCliente() {
        ...
        if (!this.contacto)   this.mensajesError.push("Ingresa un contacto");
